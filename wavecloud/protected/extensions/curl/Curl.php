...
class Curl extends CApplicationComponent{
    ...
    */
        protected function defaults(){
            ...
            isset($this->options['setOptions'][CURLOPT_SSL_VERIFYHOST]) ? $this->setOption(CURLOPT_SSL_VERIFYHOST,$this->options['setOptions'][CURLOPT_SSL_VERIFYHOST]) : $this->setOption(CURLOPT_SSL_VERIFYHOST,FALSE);
        }
    ...
    */
    public function run($url,$GET = TRUE,$POSTSTRING = array()){
        ...
        curl_close($this->ch);
        $errorarr = array();
        $errorarr['errorcode'] = $this->error_code;
        $errorarr['errorstring'] = $this->error_string;
        return $errorarr;
